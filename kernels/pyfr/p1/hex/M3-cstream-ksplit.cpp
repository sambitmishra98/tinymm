...
gimmik_mm_8x24(const double* __restrict__ b, double* __restrict__ c)
{
    ...
    if (threadIdx.y == 0)
    {
        ...
        dotp = (1.366025403784439*bv[0] + 1.366025403784439*bv[2] + -0.3660254037844385*bv[4] + -0.3660254037844385*bv[6] + 1.366025403784439*bv[8] + -0.3660254037844385*bv[10]);
        cv[0] = dotp;
        dotp = (1.366025403784439*bv[4] + -0.3660254037844385*bv[8]);
        csub[0][1][threadIdx.x] = dotp;
        bv[1] = __ldcg(b + i + 2*ldb); 
        bv[11] = __ldcg(b + i + 22*ldb); 
        dotp = (1.366025403784439*bv[1] + -0.3660254037844385*bv[2] + 1.366025403784439*bv[6] + -0.3660254037844385*bv[11]);
        cv[1] = dotp;
        dotp = make_zero();
        ...
        dotp = (-0.3660254037844385*bv[0] + 1.366025403784439*bv[3] + -0.3660254037844385*bv[5] + -0.3660254037844385*bv[7] + 1.366025403784439*bv[9] + 1.366025403784439*bv[10]);
        cv[2] = dotp;
        dotp = (1.366025403784439*bv[5] + -0.3660254037844385*bv[9]);
        csub[0][5][threadIdx.x] = dotp;
        dotp = (-0.3660254037844385*bv[1] + -0.3660254037844385*bv[3] + 1.366025403784439*bv[7] + 1.366025403784439*bv[11]);
        cv[3] = dotp;
        dotp = make_zero();
    ...
    if (threadIdx.y == 1)
    {
        ...
        dotp = (1.366025403784439*bv[0] + 1.366025403784439*bv[2] + -0.3660254037844385*bv[6] + -0.3660254037844385*bv[10]);
        cv[0] = dotp;
        bv[4] = __ldcg(b + i + 9*ldb); 
        bv[8] = __ldcg(b + i + 17*ldb); 
        dotp = (-0.3660254037844385*bv[4] + 1.366025403784439*bv[8]);
        csub[0][2][threadIdx.x] = dotp;
        bv[1] = __ldcg(b + i + 3*ldb); 
        bv[11] = __ldcg(b + i + 23*ldb); 
        dotp = (1.366025403784439*bv[1] + -0.3660254037844385*bv[2] + 1.366025403784439*bv[4] + 1.366025403784439*bv[6] + -0.3660254037844385*bv[8] + -0.3660254037844385*bv[11]);
        cv[1] = dotp;
        dotp = make_zero();
        csub[0][4][threadIdx.x] = dotp;
        bv[3] = __ldcg(b + i + 7*ldb); 
        bv[7] = __ldcg(b + i + 15*ldb); 
        dotp = (-0.3660254037844385*bv[0] + 1.366025403784439*bv[3] + -0.3660254037844385*bv[7] + 1.366025403784439*bv[10]);
        cv[2] = dotp;
        bv[5] = __ldcg(b + i + 11*ldb); 
        bv[9] = __ldcg(b + i + 19*ldb); 
        dotp = (-0.3660254037844385*bv[5] + 1.366025403784439*bv[9]);
        csub[0][6][threadIdx.x] = dotp;
        dotp = (-0.3660254037844385*bv[1] + -0.3660254037844385*bv[3] + 1.366025403784439*bv[5] + 1.366025403784439*bv[7] + -0.3660254037844385*bv[9] + 1.366025403784439*bv[11]);
        cv[3] = dotp;
        __barrier_sync(0);
