...
gimmik_mm_24x8(const double* __restrict__ b, double* __restrict__ c)
{
    ...
    if (threadIdx.y == 0)
    {
        ...
        dotp = (0.8660254037844386*bv[0] + 0.8660254037844386*bv[1]);
        cv[4] = dotp;
        dotp = make_zero();
        ...
        dotp = (0.8660254037844386*bv[2] + 0.8660254037844386*bv[3]);
        cv[6] = dotp;
        dotp = make_zero();
        ...
        dotp = (0.8660254037844386*bv[0] + 0.8660254037844386*bv[2]);
        cv[8] = dotp;
        dotp = make_zero();
        csub[0][17][threadIdx.x] = dotp;
        dotp = (0.8660254037844386*bv[1] + 0.8660254037844386*bv[3]);
        cv[9] = dotp;
        dotp = make_zero();
